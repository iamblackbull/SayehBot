...
//             .setAuthor({
//               name: `${user_name}`,
//               iconURL: utils.thumbnails.twitch_hamid,
//               url: url,
//             })
//             .setTitle(`**${title}**`)
//             .setURL(url)
...
//             )
//             .setThumbnail(utils.thumbnails.twitch_hamid)
...
//           embed.setImage(utils.thumbnails.twitch_offline_hamid);
